...
# from transformer_mvit import TransformerEncoder
...
def mobile_vit_small(num_classes: int = 1000):
    ...
    # check_point = torch.load("backbone/mobilevit_s.pt", map_location=torch.device('cuda'))
    # m.load_state_dict(check_point)
